...
var (
	pattern_CalculatorService_Sum_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "v1", "calculator", "sum"}, "", runtime.AssumeColonVerbOpt(true)))
)
